import { ButtonCVDownload, SubTitle, Title } from "@/components/Core";
...
const Hero = () => {
  return (
    <div
      id="sobre"
      className="container h-screen flex justify-center items-center bg-[#111] lg:-mt-20 lg:px-24 px-4"
    >
        ...
        <div>
          <div>
            ...
            <div className="flex justify-center gap-8">
              <ButtonCVDownload
                target="_blank"
                url="nilton_rocha_desenvolvedor.pdf"
              >
                Download CV
              </ButtonCVDownload>
